...
latex_documents = [
    (master_doc, 'cluster_utils.tex', 'cluster\\_utils Documentation',
     'Max Planck Institute for Intelligent Systems', 'manual'),
]
...
man_pages = [
    (master_doc, 'cluster_utils', 'cluster_utils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cluster_utils', 'cluster_utils Documentation',
     author, 'cluster_utils', 'One line description of project.',
     'Miscellaneous'),
]
