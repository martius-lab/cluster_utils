...
git_local_path = os.path.join(home, 'tmp/exp/repo')
results_path = os.path.join(home, 'tmp/exp/results')
...
paths_and_files = dict(git_local_path=git_local_path,
                       script_to_run='examples/sbl/git_test.py', # relative to git_local_path
